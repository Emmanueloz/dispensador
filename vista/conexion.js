...
function mostrarListaRegistros(registros) {
  registros.forEach((registro) => {
    ...
    let mensaje = "Ya esta en ese estado";
    if (estado == 1) {
      mensaje = "Abierto";
    } else if (estado != -1) {
      mensaje = "Cerrado";
    ...
    switch (tipo) {
      case "contenedor1":
        document.getElementById("ContenedorAgua").textContent = `${estado}`;
        break;
      case "contenedor2":
        document.getElementById("ContenedorComida").textContent = `${estado}`;
        break;
      case "dispensador1":
      ...
      case "dispensador2":
        ...
        break;
      case "recipiente1":
        document.getElementById("RecienteAgua").textContent = `${estado}`;
        break;
      case "recipiente2":
        document.getElementById("RecienteComida").textContent = ` ${estado}`;
        break;
      case "tResultado1":
        document.getElementById("Resultado1").textContent = `${estado}`;
        break;
      case "tResultado2":
        document.getElementById("Resultado2").textContent = `${estado}`;
        break;
      default:
        break;
    }
...
function mostrarRegistrosDeTiempo(registrosDeTiempo) {
  ...
  if (tiempo1) {
    ...
    document.getElementById(
      "Tiempo1"
    ).textContent = `${tiempo1.intervalo} ${tipoTiempo1}`;
  } else {
    document.getElementById(
      "Tiempo1"
    ).textContent = `Tiempo 1: No hay información disponible`;
  }
  if (tiempo2) {
    const tipoTiempo2 =
      tiempo2.tipo === "m"
    ...
    document.getElementById(
      "Tiempo2"
    ).textContent = `${tiempo2.intervalo} ${tipoTiempo2}`;
  } else {
    document.getElementById(
      "Tiempo2"
    ).textContent = `Tiempo 2: No hay información disponible`;
  }
}
...
inicializarYActualizarRango(
  "tiempoAgua",
  "rangeValue1",
  "test/estados/tiempo1/intervalo"
);

inicializarYActualizarRango(
  "tiempoComida",
  "rangeValue2",
  "test/estados/tiempo2/intervalo"
);
...
document.getElementById("filter-button").addEventListener("click", () => {
  ...
  ref.on("value", (snapshot) => {
    ...
    snapshot.forEach((childSnapshot) => {
      ...
      if (
        (categoryFilter === "all" || nombre.toLowerCase() === categoryFilter) &&
